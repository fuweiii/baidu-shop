...
//        GoodsDoc goodsDoc = this.esGoods(id);
//        elasticsearchRestTemplate.save(goodsDoc,GoodsDoc.class);
//        return this.setResultSuccess();
//    }
//
//    //param规格参数查询
...
//
//    //根据id查询一条数据并赋值
//    private GoodsDoc esGoods(Integer id){
//        List<GoodsDoc> goodsDocs = new ArrayList<>();
//        SpuDTO spuDTO = new SpuDTO();
//        spuDTO.setId(id);
//        GoodsDoc query = this.query(spuDTO);
//        return query;
//    }
//
...
//
//    //公共代码(摘出)
//    private GoodsDoc query(SpuDTO spuDTO){
